        ...
        <form className="mt-4 divide-y divide-gray-400">
            ...
            <div className="py-2">
                ...
                <div className="flex items-center mt-5 justify-center">
                    <button onClick={submitHandler}  className="bg-green-500 text-white py-2 px-4 rounded-lg mr-2">Gross Income</button>
                    <button className="bg-green-500 text-white py-2 px-4 rounded-lg">Net Income</button>
                </div>
            </div>
            <div className="py-2 flex items-center">
              <Link to="income" className="bg-blue-500 w-3/5 text-white mt-10  py-2 px-8 rounded-lg m-auto">Calculate</Link>  
            </div>
        </form>
            </div>
         </main>
